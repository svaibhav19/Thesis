...
public class JsonMapperImp2 implements JsonMapper {

	private Anno4j anno4j;

	public JsonMapperImp2() throws RepositoryException, RepositoryConfigException {
		anno4j = new Anno4j();
	}
	...
	public Annotation convertJsonToAnnotation(AnnotationJson jsonObj)
		...
		createAndAddBody(annotation, jsonObj.getBodyList());
	...
	private void createAndAddBody(Annotation annotation, List<Body> bodyList) {

		for (Body bodies : bodyList) {
