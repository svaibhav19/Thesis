...
//	String annotationURL = PropertyHandler.instance().baseURL;
	...
	public AnnotationGeneratorImpl() throws RepositoryException, RepositoryConfigException {
		qureyUtil = new QueryUtil();
		anno4j = new Anno4j();
	}

	public AnnotationGeneratorImpl(Anno4j anno4j) {
		this.anno4j = anno4j;
		qureyUtil = new QueryUtil();
	}
	 ...
	 */
	@Override
	public void processXML(PcGtsType pcgtsTypeObj,String digitalObjID, String softAgentResourceID) throws RepositoryException, IllegalAccessException,
	...
	@Override
	public List<Model> createOtherAnnotations(PcGtsType pcgtsTypeObj, String softAgentResourceID,String digitalObjID) throws RepositoryException,
...
//		textBody.setValue(regions.getCoords().toString());
	...
	@Override
	public Model createPageAnnotation(PcGtsType pcgtsTypeObj, String softAgentResourceID, String digitalObjID) throws RepositoryException,
			IllegalAccessException, InstantiationException, MalformedQueryException, UpdateExecutionException {
		Annotation annoations = createAnnoataionPart(pcgtsTypeObj.getMetadata(), softAgentResourceID);
...
//		writeTofile(annoations, "pageAnnotation");
	...
	@Override
	public SpecificResource getTarget(String points,String digitalObjID)
			throws RepositoryException, IllegalAccessException, InstantiationException, MalformedQueryException, UpdateExecutionException {
	 ...
	 */
	@Override
	public String checkAgentInRegistry(MetadataType metadata)
