...
public class RDF2AnnoJsonConverter {
...
//
	...
	private JSONArray getBody(List<HasBodyType> bodyList) {
	...
	private JSONArray createResource(ResourceBodyType resource) {
	...
	private JSONArray createChoice(ChoiceType choice) {
		JSONArray jsonArray = new JSONArray();
	...
	private JSONArray createCreationProvenance(CreationProvenanceType creationProvenance) {
		JSONArray jsonArray = new JSONArray();
	...
	private JSONArray createExternalWebResource(ExternalWebResourceType externalWebResource) {
	...
	private JSONObject checkItemsType(ItemsType externalItem) {
	...
	private JSONObject externalWebResourceType(ExternalWebResourceType externalWebResource) {
	...
	private JSONObject getResourceType(ResourceBodyType resource) {
		JSONObject bodyitem = new JSONObject();
		bodyitem.put("type", "TextualBody");
	...
	private JSONObject embeddedContent(EmbeddedContentType embeddedContent) {
		JSONObject bodyitem = new JSONObject();
		bodyitem.put("type", "TextualBody");
	...
	private JSONObject creationProvenance(CreationProvenanceType creationProvenanceType) {
		JSONObject bodyitem = new JSONObject();
		bodyitem.put("type", "TextualBody");
